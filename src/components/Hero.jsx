    ...
    <header className="bg-white dark:bg-gray-900">
                <div className="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="block rounded-sm bg-gray-100 dark:bg-gray-800 p-2.5 text-gray-600 dark:text-gray-400 transition hover:text-gray-600/75 dark:hover:text-gray-300/75 md:hidden">
         ...
         {/* Right Image */}
           ...
           <div className='relative'>
                <div className='rounded-xl overflow-hidden shadow-xl border border-slate-200'>
                    <img src="\" alt="FlowPilot Dashboard" className='w-full h-auto' /> 
                </div>
